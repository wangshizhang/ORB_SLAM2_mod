...
do evo_ape tum groundtruth.tum CameraTrajectory_RGBD_nogfs_nomih_$count_gfs.txt -va --save_results error_res_nogfs_nomih_$count_gfs.zip;
...
evo_ape tum groundtruth.tum CameraTrajectory_RGBD_nogfs_mih4_$count_gfs.txt -va --save_results error_res_nogfs_mih4_$count_gfs.zip;
...
evo_ape tum groundtruth.tum CameraTrajectory_RGBD_nogfs_mih8_$count_gfs.txt -va --save_results error_res_nogfs_mih8_$count_gfs.zip;
...
evo_ape tum groundtruth.tum CameraTrajectory_RGBD_nogfs_mih-11_blocksize10_$count_gfs.txt -va --save_results error_res_nogfs_mih-11_$count_gfs.zip;
rm -rf error_res_nogfs_mih-11_$count_gfs;
mkdir error_res_nogfs_mih-11_$count_gfs;
unzip -d error_res_nogfs_mih-11_$count_gfs error_res_nogfs_mih-11_$count_gfs.zip;
rm -f error_res_nogfs_mih-11_$count_gfs.zip;

evo_ape tum groundtruth.tum CameraTrajectory_RGBD_nogfs_mih16_$count_gfs.txt -va --save_results error_res_nogfs_mih16_$count_gfs.zip;
...
evo_ape tum groundtruth.tum CameraTrajectory_RGBD_nogfs_mih32_$count_gfs.txt -va --save_results error_res_nogfs_mih32_$count_gfs.zip;
